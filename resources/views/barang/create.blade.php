...
<head>
    ...
    <title>Tambah Barang Baru - Sistem Aset Kelas</title>
    ...
    <div class="max-w-2xl mx-auto px-4">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 text-sm">Isi formulir di bawah ini untuk menambahkan data barang.</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <form action="{{ route('barang.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="kode_barang" id="kode_barang" value="{{ old('kode_barang') }}" placeholder="Contoh: BRG-001" required
                ...
                <div>
                    ...
                    <input type="text" name="kategori_barang" id="kategori_barang" value="{{ old('kategori_barang') }}" placeholder="Contoh: Elektronik / Mebel" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="merk" id="merk" value="{{ old('merk') }}" placeholder="Contoh: Samsung / Olympic" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    </div>
                    <div>
                        <label for="tipe" class="block text-sm font-medium text-gray-700 mb-1">Tipe</label>
                        <input type="text" name="tipe" id="tipe" value="{{ old('tipe') }}" placeholder="Contoh: Smart TV 43 Inch" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="harga" id="harga" value="{{ old('harga') }}" min="0" placeholder="0" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                </div>
                ...
                <div class="pt-4 flex items-center justify-end gap-3 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm transition">
                        Simpan Barang
                    </button>
                </div>
            </form>
